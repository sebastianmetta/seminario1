...
<div class="fieldcontain ${hasErrors(bean: productoInstance, field: 'estado', 'error')} required">
	...
	<g:select id="estado" name="estado.id" from="${productos.EstadoProducto.list()}" optionKey="id" required="" value="${productoInstance?.estado?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: productoInstance, field: 'tamanio', 'error')} required">
	...
	<g:select id="tamanio" name="tamanio.id" from="${productos.Tamanio.list()}" optionKey="id" required="" value="${productoInstance?.tamanio?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: productoInstance, field: 'tipoProducto', 'error')} required">
	...
	<g:select id="tipoProducto" name="tipoProducto.id" from="${productos.TipoProducto.list()}" optionKey="id" required="" value="${productoInstance?.tipoProducto?.id}" class="many-to-one"/>
</div>

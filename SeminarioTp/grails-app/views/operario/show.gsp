	...
	<body>
		...
		<div id="show-operario" class="content scaffold-show" role="main">
			...
			<ol class="property-list operario">
				...
				<g:if test="${operarioInstance?.fechaDeNacimiento}">
				<li class="fieldcontain">
					<span id="fechaDeNacimiento-label" class="property-label"><g:message code="operario.fechaDeNacimiento.label" default="Fecha De Nacimiento" /></span>
					
						<span class="property-value" aria-labelledby="fechaDeNacimiento-label"><g:formatDate date="${operarioInstance?.fechaDeNacimiento}" /></span>
